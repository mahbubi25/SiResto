...
INSERT INTO `booking` (`id_booking`, `id_detail_menu`, `id_meja`, `nama_pemesan`, `nomor_hp`, `tanggal_pesan`, `tanggal_reservasi`, `id_jam`, `total_pembayaran`, `total_sudah_dibayar`, `batas_pembayaran_dp`, `status_pembayaran`, `bukti_pembayaran`) VALUES
(9, 'INV20211015132542', 5, 'Riza Zulfahnur', '99678', '2021-10-15 13:25:42', '2021-11-04', 2, 45000, 29102041144725, '2021-11-04', 'Pesanan Selesai', 'Capture.PNG');
...
--
ALTER TABLE `booking`
  MODIFY `id_booking` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
